...
// This file provides access to dynamically generated test keys
// Keys are generated at runtime by generate-test-keys.sh to avoid
// committing private keys to the repository
...
// GetTestPrivateKey returns the test private key, loading it once from disk
// The key is generated by generate-test-keys.sh and stored in /tmp/cluster-manager-test-keys/
func GetTestPrivateKey() (*rsa.PrivateKey, error) {
	testPrivateKeyOnce.Do(func() {
		...
		// Try PKCS8 first (openssl genrsa default format for newer versions)
